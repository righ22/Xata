...
--
-- Хост: localhost
-- Время создания: Сен 04 2012 г., 22:25
...
INSERT INTO `tbl_country` (`id`, `caption`) VALUES
(1, 'China'),
(2, 'Ukrain');
...
INSERT INTO `tbl_xata` (`id`, `type_id`, `city_id`, `address`, `owner`, `cost`, `rental_m`, `rental_d`, `rental_h`, `visit`) VALUES
(1, 1, 2, 'Магистральная 84б кв 9', 1, NULL, NULL, NULL, NULL, 5),
(3, 1, 2, 'Магистральная 84б кв 9', 1, NULL, NULL, NULL, NULL, 5),
(4, 1, 2, 'Магистральная 84б кв 9', 22, 60000, 200, 50, 20, 5);
